...
export default function Admin(){
  ...
  const filtered=useMemo(()=>orders.filter(o=>(filter==="全部"||o.status===filter)&&[o.orderId,o.name,o.phone,o.date,o.product].join(" ").toLowerCase().includes(query.toLowerCase())),[orders,query,filter]);
